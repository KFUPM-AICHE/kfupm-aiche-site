    ...
    },
    {
      ...
      benefits: [
        ...
        },
        {
          ...
          description: "Opportunity for the sponsor to have a speaking slot at one of our smaller events or workshops, allowing them to interact directly with students and establish their presence"
        }
      ]
    }
  ];
          ...
          {sponsorshipPackages.map((pkg, index) => (
            ...
            >
              ...
              <div 
                style={{
                  ...styles.cardGlow,
                  background: `linear-gradient(135deg, ${pkg.color}60, ${pkg.color}20)`,
              ...
              <div style={styles.packageFooter}>
                <button
                  style={{
                    ...
                    boxShadow: `0 5px 15px ${pkg.color}30`,
                  }}
                  onMouseEnter={(e) => {
                    e.target.style.transform = 'scale(1.05)';
                    e.target.style.boxShadow = `0 8px 20px ${pkg.color}50`;
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.transform = 'scale(1)';
                    e.target.style.boxShadow = `0 5px 15px ${pkg.color}30`;
                  }}
                >
                  Select {pkg.name}
                </button>
